        ...
        <div>
          ...
          <?php if(Entrust::can('Facturacion')): ?>
           ...
           <li class="site-menu-item has-sub">
            ...
            <li class="site-menu-item has-sub  <?php echo e(Route::is('GestionDeUsuarios.index','GestionDeRoles.index') ? 'active' : ''); ?> <?php echo e(Route::is('GestionDeUsuarios.index','GestionDeRoles.index') ? 'open' : ''); ?> ">
                  ...
                  <ul class="site-menu-sub ">
                    <li class="site-menu-item <?php echo e(Route::is('GestionDeUsuarios.index') ? 'active' : ''); ?>  is-shown">
                      <a class="animsition-link waves-effect waves-classic" href="<?php echo e(route('GestionDeUsuarios.index')); ?>">
                        <span class="site-menu-title">Gestión de Usuarios</span>
                      </a>
                    </li>
                    <li class="site-menu-item <?php echo e(Route::is('GestionDeRoles.index') ? 'active' : ''); ?>">
                      <a class="animsition-link waves-effect waves-classic" href="<?php echo e(route('GestionDeRoles.index')); ?>">
